...
def _extract_transcript(result) -> str | None:
    ...
    Delegiert an providers.deepgram_stream für Implementierung.
    """
    from providers.deepgram_stream import _extract_transcript as extract_impl
    return extract_impl(result)


# =============================================================================
# Deepgram WebSocket Streaming (delegiert an providers/deepgram_stream.py)
# =============================================================================
# Die Streaming-Logik wurde nach providers/deepgram_stream.py ausgelagert.
# Hier folgen nur noch Wrapper für Rückwärtskompatibilität.
# =============================================================================
