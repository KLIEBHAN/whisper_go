...
- **Download:** `PulseScribe-1.0.0.dmg` (asset below)
...
- **Deepgram (WebSocket streaming):** transcribes _during recording_ for minimal latency
...
1. Download `PulseScribe-1.0.0.dmg` from the assets below.
